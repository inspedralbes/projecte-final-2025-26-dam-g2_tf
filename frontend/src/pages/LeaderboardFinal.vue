    ...
    <div class="w-full max-w-md bg-white/5 p-6 rounded-3xl border border-white/10">
      ...
      <div class="flex justify-center gap-4 text-3xl mb-6">
        <button v-for="i in 5" :key="i" @click="puntuacio = i" 
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="puntuacio >= i ? 'fill-yellow-400 stroke-yellow-400' : 'fill-transparent stroke-white/20'" viewBox="0 0 24 24" stroke-width="1.5">
